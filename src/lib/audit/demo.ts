...
export const demoAudit: AuditRecord = {
  ...
  report: {
    ...
    copySuggestions: [
      { label: "headline", before: "One workspace for modern teams", after: "Ship client work on time — without another status meeting.", rationale: "Names the outcome and removes an acute pain instead of describing a generic category." },
      { label: "subheadline", before: "Plan, collaborate and ship your best work.", after: "Northstar gives agencies one clear place to plan projects, collect feedback and keep every client in the loop.", rationale: "Identifies the audience and explains the mechanism in concrete language." },
      { label: "cta", before: "Start free", after: "Plan my first project free", rationale: "Connects the click to an immediate, low-risk outcome." },
      { label: "hero", before: "Headline + subheadline + CTA + product image", after: "Outcome headline + agency-specific explanation + CTA + no-card reassurance + rating/logos", rationale: "Pairs the promise with proof and risk reduction before the visitor scrolls." },
    ],
